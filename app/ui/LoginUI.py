...
class Ui_Form_login(object):
    def setupUi(self, Form_login):
        ...
        self.pushButton_username = QtWidgets.QPushButton(Form_login)
        self.pushButton_username.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.pushButton_username.setText("")
        self.pushButton_username.setFlat(True)
        self.pushButton_username.setObjectName("pushButton_username")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.pushButton_username)
        self.pushButton_password = QtWidgets.QPushButton(Form_login)
        self.pushButton_password.setText("")
        self.pushButton_password.setFlat(True)
        self.pushButton_password.setObjectName("pushButton_password")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.pushButton_password)
