...
class Ui_Form_notify(object):
    def setupUi(self, Form_notify):
        ...
        self.pushButton_update.setMinimumSize(QtCore.QSize(0, 0))
        ...
        spacerItem = QtWidgets.QSpacerItem(676, 19, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Form_notify):
        ...
        self.widget_tool.setProperty("class", _translate("Form_notify", "toolbar"))
        self.label.setText(_translate("Form_notify", "name"))
        self.label_4.setText(_translate("Form_notify", "start_time"))
